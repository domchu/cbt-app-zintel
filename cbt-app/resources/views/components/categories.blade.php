...
<div class="my-24 border">
     <div class="text-center">
        <p class="text-orange-600 uppercase font-semibold">categories</p>
        <h1 class="py-2 text-4xl font-bold text-[#32064a]">Comprehensive learning programs for all students</h1>
        <p class="text-gray-500 text-lg">Become life long learners with the best teachers, engaging video<br> 
        lessons and personalised learning journeys.
    </p>
     </div>

     <main class="mt-12 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-10 lg:gap-5 sm:px-0 px-8">
